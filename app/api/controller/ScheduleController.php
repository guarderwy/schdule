...
class ScheduleController
{
     ...
     * 生成本周模拟排班数据
     */
    public function generateMockData(Request $request, ScheduleService $service)
    {
        $weekNo = $request->param('week_no', 1);
        ...
        return json(['code' => 0, 'msg' => '模拟数据生成成功', 'data' => $mockSchedule]);
    }
}